...
import { WorkOrderHeader } from "@/pages/admin/equipos/workorders/WorkOrderHeader";
import { WorkOrderFilters } from "@/pages/admin/equipos/workorders/WorkOrderFilters";
import { WorkOrderTable } from "@/pages/admin/equipos/workorders/WorkOrderTable";
import { WorkOrderPagination } from "@/pages/admin/equipos/workorders/WorkOrderPagination";
import { WorkOrderFormModal } from "@/pages/admin/equipos/workorders/WorkOrderFormModal";
import { WorkOrderDetailView } from "@/pages/admin/equipos/workorders/WorkOrderDetailView";
import { CompleteMaintenanceModal } from "@/pages/admin/equipos/workorders/CompleteMaintenanceModal";
import { useOrdenesTrabajo } from "@/pages/admin/equipos/workorders/useOrdenesTrabajo";
