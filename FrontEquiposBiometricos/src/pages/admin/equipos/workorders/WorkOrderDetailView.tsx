...
import { WorkOrderInfo } from "@/pages/admin/equipos/workorders/WorkOrderInfo";
import { ChildSection, CostSection } from "@/pages/admin/equipos/workorders/WorkOrderSections";
