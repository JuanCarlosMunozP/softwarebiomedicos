...
import { EquipoFicha } from "@/pages/admin/equipos/EquipoFicha";
import { EquipmentHeader } from "@/pages/admin/equipos/EquipmentHeader";
import { EquipmentFilters } from "@/pages/admin/equipos/EquipmentFilters";
import { EquipmentTable } from "@/pages/admin/equipos/EquipmentTable";
import { EquipmentPagination } from "@/pages/admin/equipos/EquipmentPagination";
import { EquipmentFormModal } from "@/pages/admin/equipos/EquipmentFormModal";
import { MarcasModelosPanel } from "@/pages/admin/equipos/catalogo/MarcasModelosPanel";
import type { MarcasModelosPanelHandle } from "@/pages/admin/equipos/catalogo/MarcasModelosPanel";
